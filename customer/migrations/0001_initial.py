    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advocate.tbl_adv')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('adv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='advocate.tbl_adv')),
                ('u', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer.case')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('C_gen', models.CharField(default='', max_length=10)),
                ('C_dob', models.DateField()),
                ('C_ph', models.CharField(max_length=10)),
                ('C_state', models.CharField(default='', max_length=30)),
